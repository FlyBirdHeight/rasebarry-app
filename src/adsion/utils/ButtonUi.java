...
public class ButtonUi extends JButton {
    ...
    public static final Color BUTTON_COLOR1 = new Color(90, 217, 221);
    public static final Color BUTTON_COLOR2 = new Color(90, 217, 221);
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (getModel().isPressed()) {
            p1 = new GradientPaint(0, 0, new Color(255, 255, 255), 0, h - 1,
                    new Color(255, 255, 255));
            p2 = new GradientPaint(0, 1, new Color(255, 255, 255, 255), 0, h - 3,
                    new Color(255, 255, 255, 255));
        } else {
            p1 = new GradientPaint(0, 0, new Color(255, 255, 255), 0, h - 1,
                    new Color(255, 255, 255));
            p2 = new GradientPaint(0, 1, new Color(255, 255, 255, 255), 0,
                    h - 3, new Color(255, 255, 255, 255));
        }
