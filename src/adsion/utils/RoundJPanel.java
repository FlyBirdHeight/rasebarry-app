...
public class RoundJPanel extends Border {
    protected int m_w = 6;
    protected int m_h = 6;
    protected Color m_topColor = new Color(127,127,127);
    protected Color m_bottomColor = new Color(127,127,127);
    protected boolean roundc = false; // Do we want rounded corners on the border?
    public RoundJPanel(boolean round_corners)
    {
